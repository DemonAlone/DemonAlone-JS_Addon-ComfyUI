...
class LoadVideoNodes2:
    ...
    def INPUT_TYPES(cls):
        ...
        file_list = ["None"] # Add a placeholder at the very beginning
            ...
            for root, dirs, files in os.walk(input_dir, followlinks=True):
                ...
                for file in files:
                    ...
                    if ext in supported_ext:
                        ...
                        disk_files.append(relpath)
            
            disk_files.sort()
            file_list.extend(disk_files)
            
        if len(file_list) == 1:
            file_list = ["None", "No video files found"]
            
        return {
            "required": {
                "video": (file_list, {"video_upload": True}),
